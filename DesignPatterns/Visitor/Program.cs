...
namespace Visitor
{
    internal class Program
    {
        ...
        {
            Manager manager1 = new Manager { Name = "Erdem" , Salary = 3500};
            Manager manager2 = new Manager { Name = "Derya", Salary = 1800 };

            Worker worker1 = new Worker { Name = "Sevim" , Salary=4250};
            Worker worker2 = new Worker { Name = "Kemal", Salary = 5000 };
    ...
    class Payrise : VisitorBase
    {
        ...
        public override void Visit(Manager manager)
        {
            Console.WriteLine("{0} paid {1}", manager.Name, manager.Salary * (decimal)1.2);
        }
    }
}
